...
Der bisherige Entwurf des Layouts wurde nicht verworfen und ist im
Pythonmodul ``models`` enthalten, da die Datenbank aktuell jedoch nicht zum
Einsatz kommt und es somit „toter Code“ ist, wird an dieser Stelle nicht
